...
def render_graph_ReSTIR_FG_Test():
    g = RenderGraph('ReSTIR_FG_Test')
    g.create_pass('ReSTIR_FG_Test', 'ReSTIR_FG_Test', {})
    ...
    g.add_edge('VBufferRT.vbuffer', 'ReSTIR_FG_Test.vbuffer')
    g.add_edge('VBufferRT.mvec', 'ReSTIR_FG_Test.mvec')
    g.add_edge('ReSTIR_FG_Test.color', 'AccumulatePass.input')
    g.add_edge('AccumulatePass.output', 'ToneMapper.src')
    g.mark_output('ToneMapper.dst')
    g.mark_output('AccumulatePass.output')
    return g

ReSTIR_FG_Test = render_graph_ReSTIR_FG_Test()
try: m.addGraph(ReSTIR_FG_Test)
