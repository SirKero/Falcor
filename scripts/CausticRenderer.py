...
def render_graph_DefaultRenderGraph():
    ...
    g.create_pass('DLSSPass', 'DLSSPass', {'enabled': False, 'outputSize': 'Default', 'profile': 'DLAA', 'preset': 'Default(?)', 'motionVectorScale': 'Relative', 'isHDR': True, 'useJitteredMV': False, 'sharpness': 0.0, 'exposure': 0.0})
