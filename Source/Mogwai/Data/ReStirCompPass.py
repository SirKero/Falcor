...
def render_graph_ReStirCompairison():
    g = RenderGraph('ReStirCompairison')
    ...
    g.addEdge('RTXDIPass.color', 'AccumulatePass0.input')
    g.addEdge('AccumulatePass0.output', 'SplitScreenPass.rightInput')
    g.addEdge('SplitScreenPass.output', 'ToneMapper.src')
    g.markOutput('ToneMapper.dst')
    return g

ReStirCompairison = render_graph_ReStirCompairison()
try: m.addGraph(ReStirCompairison)
