...
def render_graph_RTXDI():
    ...
    g.addEdge('PhotonReSTIR.color', 'Composite.B')
    ...
    g.addEdge('VBufferRT.mvec', 'PhotonReSTIR.MVec')
    g.addEdge('VBufferRT.vbuffer', 'PhotonReSTIR.VBuffer')
    g.addEdge('VBufferRT.viewW', 'PhotonReSTIR.View')
