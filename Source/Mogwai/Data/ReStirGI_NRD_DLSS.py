...
def render_graph_ReSTIRGI_NRD_DLSS():
    g = RenderGraph('ReSTIRGI_NRD_DLSS')
    ...
    g.addEdge('ReSTIRGI.diffuseIllumination', 'CompositeReStirNRD.PhotonReStirDiffuse')
    g.addEdge('ReSTIRGI.specularIllumination', 'CompositeReStirNRD.PhotonReStirSpecular')
...
ReSTIRGI_NRD_DLSS = render_graph_ReSTIRGI_NRD_DLSS()
try: m.addGraph(ReSTIRGI_NRD_DLSS)
