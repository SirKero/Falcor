...
def render_graph_FG_ReSTIR_NRD_DLSS():
    ...
    VBufferPM = createPass('VBufferPM', {'outputSize': IOSize.Default, 'samplePattern': 0, 'specRoughCutoff': 0.5, 'sampleCount': 32, 'useAlphaTest': True, 'adjustShadingNormals': True})
    ...
    ImageFilter = createPass('ImageFilter')
    g.addPass(ImageFilter, 'ImageFilter')
    ...
    g.addEdge('ImageFilter.OutA', 'ModulateIllumination.deltaReflectionReflectance')
    g.addEdge('ImageFilter.OutB', 'ModulateIllumination.deltaTransmissionReflectance')
    g.addEdge('VBufferPM.NRDDeltaReflectionReflectance', 'ImageFilter.ImgA')
    g.addEdge('VBufferPM.NRDDeltaTransmissionReflectance', 'ImageFilter.ImgB')
    g.addEdge('DLSSPass.output', 'AccumulatePass.input')
    g.addEdge('NRDReflectionMotionVectors.reflectionMvec', 'ImageFilter.MvecA')
    g.addEdge('NRDTransmissionMotionVectors.deltaMvec', 'ImageFilter.MvecB')
