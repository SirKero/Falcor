...
namespace
{
    const std::string kShaderFolder = "RenderPasses/ReSTIR_FG_Test/";
...
{
    registry.registerClass<RenderPass, ReSTIR_FG_Test>();
}

ReSTIR_FG_Test::ReSTIR_FG_Test(ref<Device> pDevice, const Properties& props)
    : RenderPass(pDevice)
{
...
Properties ReSTIR_FG_Test::getProperties() const
{
    return {}; //TODO
}

RenderPassReflection ReSTIR_FG_Test::reflect(const CompileData& compileData)
{
...
void ReSTIR_FG_Test::renderUI(Gui::Widgets& widget) {
    bool changed = false;
...
void ReSTIR_FG_Test::setScene(RenderContext* pRenderContext, const ref<Scene>& pScene) {
    // Reset Scene
    mpScene = pScene;
...
void ReSTIR_FG_Test::execute(RenderContext* pRenderContext, const RenderData& renderData)
{
    if (!mpScene)
        return;
...
void ReSTIR_FG_Test::prepareLightingStructure(RenderContext* pRenderContext)
{
...
void ReSTIR_FG_Test::prepareResources(RenderContext* pRenderContext, const RenderData& renderData)
{
...
void ReSTIR_FG_Test::preparePhotonAccelerationStructure()
{
...
void ReSTIR_FG_Test::tracePhotonsPass(RenderContext* pRenderContext, const RenderData& renderData,  bool analyticOnly,  bool buildAS)
{
...
void ReSTIR_FG_Test::handlePhotonCounter(RenderContext* pRenderContext) {
...
void ReSTIR_FG_Test::resampleReservoirCausticPass(RenderContext* pRenderContext, const RenderData& renderData)
{
...
void ReSTIR_FG_Test::evaluateReservoirsPass(RenderContext* pRenderContext, const RenderData& renderData)
{
...
DefineList ReSTIR_FG_Test::getMaterialDefines()
{
    DefineList defines;
...
void ReSTIR_FG_Test::RayTraceProgramHelper::initProgramVars(ref<Device> pDevice, ref<Scene> pScene, ref<SampleGenerator> pSampleGenerator)
{
