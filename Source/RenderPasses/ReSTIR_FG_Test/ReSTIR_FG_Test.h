...
class ReSTIR_FG_Test : public RenderPass
{
public:
    FALCOR_PLUGIN_CLASS(ReSTIR_FG_Test, "ReSTIR_FG_Test", "More lightweight implementation of ReSTIR-FG with less options");

    static ref<ReSTIR_FG_Test> create(ref<Device> pDevice, const Properties& props) { return make_ref<ReSTIR_FG_Test>(pDevice, props); }

    ReSTIR_FG_Test(ref<Device> pDevice, const Properties& props);
